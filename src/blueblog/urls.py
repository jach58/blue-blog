...
from blog.views import (NewBlogView, HomeView, UpdateBlogView, NewBlogPostView, UpdateBlogPostView, BlogPostDetailsView,
                        SharePostWithBlog, StopSharingPostWithBlog, ShareBlogPostView)
...
urlpatterns = [
    ...
    url(r'blog/post/(?P<pk>\d+)/share/$', ShareBlogPostView.as_view(), name='share-blog-post'),
    url(r'^blog/post/(?P<post_pk>\d+)/share/to/(?P<blog_pk>\d+)/$', SharePostWithBlog.as_view(),
        name='share-post-with-blog'),
    url(r'^blog/post/(?P<post_pk>\d+)/stop/share/to/(?P<blog_pk>\d+)/$', StopSharingPostWithBlog.as_view(),
